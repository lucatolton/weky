...
module.exports.run = async (client, message, args) => {
	...
	message.channel.send(new Discord.MessageEmbed().setTitle('Success!').setDescription(`Successfully revoked **<@${target.id}>'s** Weky Moderator`,).setColor('RED'),);

	return target.send(new Discord.MessageEmbed().setTitle('Alert').setDescription(`**${message.author.tag}** revoked your Weky Moderator`).setColor('RED'));
