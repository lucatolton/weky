...
module.exports.run = async (client, message, args) => {
	...
	message.channel.send({ embeds: [new Discord.MessageEmbed().setTitle('Success!').setDescription(`Successfully added **<@${target.id}>** as Weky Moderator`).setColor('GREEN'),
	] });

	return target.send({ embeds: [new Discord.MessageEmbed().setTitle('Alert').setDescription(`**${message.author.tag}** added you as Weky Moderator`).setColor('GREEN')] });
