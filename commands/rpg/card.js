...
let total = userx.equipedHero.heroMn
let needMore = Math.round(userx.equipedHero.heroLvlUpReq)
...
let daFinder = heroes.hero.find((val) => val.name.includes(userx.equipedHero.heroName));
...
ctx.fillText(userx.equipedHero.heroHp, 100, 560 );
ctx.stroke();

ctx.beginPath()
ctx.font = '25px "Cute"';
ctx.fillStyle = '#007DC5';
ctx.fillText(userx.equipedHero.heroDmg, 100, 640 );
ctx.stroke();

ctx.beginPath()
ctx.font = '25px "Cute"';
ctx.fillStyle = '#00889B';
ctx.fillText(userx.equipedHero.heroLvl, 380, 560 );
ctx.stroke();
//hp^dmg ---------------------------------------
ctx.beginPath()
ctx.font = '25px "Cute"';
